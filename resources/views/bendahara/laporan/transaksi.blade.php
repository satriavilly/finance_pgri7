...
<div class="space-y-4">
    ...
    <div class="bg-white rounded-xl shadow-sm p-4">
        <form method="GET" action="{{ route('bendahara.laporan.transaksi') }}" class="grid grid-cols-2 md:grid-cols-6 gap-3">
            ...
            <div class="flex gap-2">
                ...
                <a href="{{ route('bendahara.laporan.transaksi') }}" class="bg-gray-100 hover:bg-gray-200 text-gray-600 text-sm px-3 py-2 rounded-lg flex items-center">
