...
<div class="space-y-4">
    ...
    <div class="bg-yellow-50 border border-yellow-200 rounded-xl p-5">
        <p class="text-yellow-700">Data anak belum terdaftar. Hubungi wali kelas atau admin.</p>
    </div>
    @else

    @php
        $semuaTagihan = $anak->tagihanSiswa;
    ...
    <div class="bg-white rounded-xl shadow-sm p-4 flex items-center gap-4">
        ...
        <div class="flex-1">
            ...
            <p class="text-sm text-gray-500">NIS: {{ $anak->nis }} &middot; Kelas {{ $anak->kelas?->nama }}</p>
        </div>
