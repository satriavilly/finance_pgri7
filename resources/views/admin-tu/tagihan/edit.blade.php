            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <select name="kategori" required
                        ...
                        <option value="{{ $val }}" {{ old('kategori', $tagihan->kategori) === $val ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                ...
                <div class="border border-gray-200 rounded-xl p-4 space-y-3">
                    ...
                    <div x-show="isCicilan" x-cloak>
                        ...
                        <select name="jumlah_cicilan"
                                class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm focus:ring-2 focus:ring-blue-500 outline-none">
                            @for($i = 2; $i <= 12; $i++)
                            <option value="{{ $i }}" {{ old('jumlah_cicilan', $tagihan->jumlah_cicilan) == $i ? 'selected' : '' }}>{{ $i }}x cicilan</option>
                            @endfor
                        </select>
